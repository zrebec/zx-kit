...
| `music` | AY music by note name (`A5`, `C#4`) + looping with a mixer that holds across the loop | audio |
...
│   ├── music.ts           # noteToFreq, seq, playAYLoop, LoopHandle (note-name AY music)
